...
## Constant Product Market Maker(CFMM) 
The secret ingredient in AMMs is a mathematical formula that can take many  different forms. The most common one was proposed by Vitalik and popularized  by Uniswap. 
It's the 

`"x * y = k"` 

formula also known as Constant Product Market Maker
